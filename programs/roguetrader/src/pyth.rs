...
/// Pyth Receiver V2 program — rec5EKMGg6MxZYaMdyBfgwp4d5rB9T1VQH5pJv5LtFJ
/// Must match the program ID used by @pythnetwork/pyth-solana-receiver SDK (v0.14.0+)
...
/// Pyth Receiver V2 program (devnet — same program ID as mainnet for now)
#[cfg(feature = "devnet")]
pub const PYTH_RECEIVER_PROGRAM_ID: Pubkey = Pubkey::new_from_array([
    0x0c, 0xb7, 0xfa, 0xbb, 0x52, 0xf7, 0xa6, 0x48,
    0xbb, 0x5b, 0x31, 0x7d, 0x9a, 0x01, 0x8b, 0x90,
